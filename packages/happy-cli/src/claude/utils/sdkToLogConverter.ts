...
export class SDKToLogConverter {
    ...
    private responses?: Map<string, { approved: boolean, mode?: ClaudeSdkPermissionMode, reason?: string }>
    private sidechainLastUUID = new Map<string, string>();

    constructor(
        context: Omit<ConversionContext, 'parentUuid'>,
        responses?: Map<string, { approved: boolean, mode?: ClaudeSdkPermissionMode, reason?: string }>
    ) {
        this.context = {
            ...context,
